        ...
        <form action="{{ route('transactions.update', $transaction) }}" method="POST">
            ...
            <div class="mb-4">
                <label for="account_id" class="form-label">
                    {{ $transaction->type === 'transfer' ? 'From Account' : 'Account' }} <span class="text-danger">*</span>
                </label>
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    name="description"
                    rows="3"
                    placeholder="Add a note...">{{ old('description', $transaction->description) }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="fas fa-check me-2"></i> Update {{ ucfirst($transaction->type) }}
                </button>
