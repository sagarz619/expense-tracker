        ...
        <form action="{{ route('categories.update', $category) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea
                    ...
                    name="description"
                    rows="2"
                    placeholder="e.g., Fruits, Vegetables, Groceries">{{ old('description', $category->description) }}</textarea>
                @error('description')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
                    ...
                    @foreach($colors as $colorCode)
                        <div class="col-4">
                            <input
                                ...
                                value="{{ $colorCode }}"
                                {{ old('color', $category->color) === $colorCode ? 'checked' : '' }}>
                            <label
